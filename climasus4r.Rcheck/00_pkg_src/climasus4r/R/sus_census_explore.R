...
#' and copy codes for use with sus_census_join().
#'
...
sus_census_select <- function(dataset = "all",
                                year = 2010,
                                lang = "pt",
                                output = "browser",
                                verbose = TRUE) {
  ...
  if (output == "browser") {
    ...
    if (verbose) {
      ...
      cli::cli_bullets(c(
        ...
        "3" = "Click 'Copy Codes' to get R code for {.code sus_census_join()}",
...
generate_forest_theme_html <- function(vars_df, year, lang, selected_dataset) {
  ...
  texts <- list(
    pt = list(
      ...
      subtitle = "Selecione variaveis para usar em sus_census_join()",
      ...
      tip3 = "Use os codigos copiados no argumento 'vars' de sus_census_join()",
    ...
    en = list(
      ...
      subtitle = "Select variables to use in sus_census_join()",
      ...
      tip3 = "Use copied codes in the 'vars' argument of sus_census_join()",
    ...
    es = list(
      ...
      subtitle = "Seleccione variables para usar en sus_census_join()",
      ...
      tip3 = "Use los codigos copiados en el argumento 'vars' de sus_census_join()",
...
<body>
    <div class="container">
        ...
        <div id="codeHelp" class="code-help">
            <strong>Ready to use in sus_census_join():</strong><br>
    ...
    <script>
        ...
        function copySelectedCodes() {
            ...
            navigator.clipboard.writeText(codeString).then(() => {
                ...
                console.log("\\\\nReady to use in sus_census_join():\\\\n");
