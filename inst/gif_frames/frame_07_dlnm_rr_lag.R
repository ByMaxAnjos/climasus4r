# Frame 7/8 do GIF do pipeline: sus_mod_plot_dlnm(type = "lag")
# Rode sozinho:  Rscript scripts/gif_frames/frame_07_dlnm_rr_lag.R
...
save_frame(
  c('serie   <- dplyr::inner_join(saude_diaria, clima_diario, by = "date")',
    ...
    ')',
    'sus_mod_plot_dlnm(fit, type = "lag")'),
  sus_mod_plot_dlnm(fit, type = "lag", lang = "pt", verbose = FALSE),
  "07_dlnm_rr_lag"
)
