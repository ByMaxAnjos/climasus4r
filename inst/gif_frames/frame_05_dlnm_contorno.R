# Frame 5/8 do GIF do pipeline: sus_mod_plot_dlnm(type = "contour")
# Rode sozinho:  Rscript scripts/gif_frames/frame_05_dlnm_contorno.R
...
save_frame(
  c('serie   <- dplyr::inner_join(saude_diaria, clima_diario, by = "date")',
    ...
    ')',
    'sus_mod_plot_dlnm(fit, type = "contour")'),
  sus_mod_plot_dlnm(fit, type = "contour", lang = "pt", verbose = FALSE),
  "05_dlnm_contorno"
)
