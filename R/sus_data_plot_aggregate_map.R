...
sus_data_plot_aggregate_map <- function(
  ...
  .msgs <- list(
    pt = list(
      ...
      col_used          = "Coluna de desfecho usada: {.val {col}}",
      muni_col_used     = "Coluna municipal usada: {.val {col}}",
    ...
    en = list(
      ...
      col_used          = "Outcome column used: {.val {col}}",
      muni_col_used     = "Municipality column used: {.val {col}}",
    ...
    es = list(
      ...
      col_used          = "Columna de desenlace usada: {.val {col}}",
      muni_col_used     = "Columna municipal usada: {.val {col}}",
      period_filter     = "Filtrando per\u00edodo: {s} \u2013 {e}",
      fill_label        = "Casos",
