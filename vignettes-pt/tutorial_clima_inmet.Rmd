...
- **Usar dados de outras fontes sem adaptação** — `sus_climate_fill_inmet()` foi construída para os nomes de colunas do INMET. Usar com dados de outras redes meteorológicas sem renomear as colunas causará erros ou resultados incorretos
