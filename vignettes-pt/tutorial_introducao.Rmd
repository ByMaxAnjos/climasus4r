...
## 6. Criação de Variáveis com `sus_data_create_variables()`

Antes de filtrar, frequentemente queremos criar variáveis derivadas. A função `sus_data_create_variables()` permite criar:
